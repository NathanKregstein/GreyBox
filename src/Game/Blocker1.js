...
class Blocker1 {
    ...
    update(deltaTime,player1Score,player2Score) {
        ...
        // }
        if(player1Score >this.player1Prev){
            this.x = this.half - ((player1Score)*10);
            this.height = this.startHeight +((player1Score)*10);
            this.player1Prev = player1Score;
        }
